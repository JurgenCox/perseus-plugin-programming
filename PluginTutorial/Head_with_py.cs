...
namespace PluginTutorial
{
    public class HeadPy : PluginInterop.Python.MatrixProcessing // if you use R, replace Python to R
    {
        ...
        {
            byte[] code = (byte[])Resources.ResourceManager.GetObject("head_c_sharpPy"); // put the script to resources via edit properies file, and replace header_c_sharpPy to your script name
